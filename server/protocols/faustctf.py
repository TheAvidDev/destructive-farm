...
# Must be lowercase
RESPONSES = {
    FlagStatus.SKIPPED: ['teapot', 'brute force', 'no such flag'],
    FlagStatus.QUEUED: ['went wrong', 'start yet', 'already over', 'unknown team'],
    FlagStatus.REJECTED: ['format', 'not recognized', 'flag expired', 'own team', 'nop', 'submitted once'],
    FlagStatus.ACCEPTED: ['thank you'],
}
